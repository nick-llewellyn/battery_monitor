...
/// - `com.nllewellyn.battery_monitor/battery_level` -- battery percentage (0-100)
/// - `com.nllewellyn.battery_monitor/battery_state` -- charging state enum code (0-4)
/// - `com.nllewellyn.battery_monitor/battery_save_mode` -- Low Power Mode on/off
