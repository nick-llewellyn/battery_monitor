...
EventChannels. Event-driven on both platforms (no polling).
                       DESC
  s.homepage         = 'https://github.com/nick-llewellyn/battery_status'
  s.license          = { :type => 'MIT', :file => '../LICENSE' }
  s.author           = { 'Nicholas Llewellyn' => 'nllewelln@gmail.com' }
  s.source           = { :path => '.' }
  # Sources live under battery_status/Sources/battery_status/ to share a
  # single source tree with Package.swift (Swift Package Manager).
  s.source_files     = 'battery_status/Sources/battery_status/**/*'
